...
return [
    ...
    'GET_FBA_ESTIMATED_FBA_FEES_TXT_DATA' => [
        ...
        Regions::EUROPE => [
            ...
            'brand' => 'brand',
            'fulfilled-by' => 'fulfilled_by',
            'has-local-inventory' => 'has_local_inventory', // TODO
            'your-price' => 'your_price',
            'sales-price' => 'sales_price',
            'longest-side' => 'longest_side',
            'median-side' => 'median_side',
            ...
            'item-package-weight' => 'item_package_weight',
            'unit-of-weight' => 'unit_of_weight',
            'product-size-weight-band' => 'product_size_tier',
            'currency' => 'currency',
            'estimated-fee-total' => 'estimated_fee_total',
            'estimated-referral-fee-per-unit' => 'estimated_referral_fee_per_unit',
            'estimated-variable-closing-fee' => 'estimated_variable_closing_fee',
            'estimated-order-handling-fee-per-order' => 'estimated_order_handling_fee_per_order',
            'expected-domestic-fulfilment-fee-per-unit' => 'expected_fulfillment_fee_per_unit',
            //            'estimated-future-fee (Current Selling on Amazon + Future Fulfillment fees)' => 'estimated_future_fee',
            //            'estimated-future-order-handling-fee-per-order' => 'estimated_future_order_handling_fee_per_order',
            //            'expected-future-domestic-fulfilment-fee-per-unit' => 'expected_future_fulfillment_fee_per_unit',
            ...
            //            'expected-future-efn-fulfilment-fee-per-unit-uk' => 'expected_future_efn_fulfilment_fee_per_unit_uk',
            //            'expected-future-efn-fulfilment-fee-per-unit-de' => 'expected_future_efn_fulfilment_fee_per_unit_de',
            //            'expected-future-efn-fulfilment-fee-per-unit-fr' => 'expected_future_efn_fulfilment_fee_per_unit_fr',
            //            'expected-future-efn-fulfilment-fee-per-unit-it' => 'expected_future_efn_fulfilment_fee_per_unit_it',
            //            'expected-future-efn-fulfilment-fee-per-unit-es' => 'expected_future_efn_fulfilment_fee_per_unit_es',
        ],
    ],
    ...
    'GET_LEDGER_DETAIL_VIEW_DATA' => [
        ...
        'Reason' => 'reason',
        'Country' => 'country',
        'Reconciled Quantity' => 'reconciled_quantity',
        'Unreconciled Quantity' => 'unreconciled_quantity',
