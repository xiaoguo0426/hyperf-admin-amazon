...
//        while (true) {
//            try {
//                $response = $this->sdk->fulfillmentInbound()->getShipments($this->accessToken, $region, $query_type, $marketplace_id, $shipment_status_list, $shipment_id_list, $last_updated_after, $last_updated_before, $next_token);
//
