...
class ReportFactory
{
    public static function getInstance(int $merchant_id, int $merchant_store_id, string $region, string $report_type): ReportBase
    {
        $class = match ($report_type) {
            ...
            'GET_AMAZON_FULFILLED_SHIPMENTS_DATA_INVOICING' => AmazonFulfilledShipmentsDataInvoicingReport::class,
            //        'GET_FLAT_FILE_ALL_ORDERS_DATA_BY_LAST_UPDATE_GENERAL',
            //        'GET_FLAT_FILE_ALL_ORDERS_DATA_BY_ORDER_DATE_GENERAL',
            //        'GET_XML_ALL_ORDERS_DATA_BY_LAST_UPDATE_GENERAL',
            //        'GET_XML_ALL_ORDERS_DATA_BY_ORDER_DATE_GENERAL',
            'GET_FBA_FULFILLMENT_CUSTOMER_SHIPMENT_SALES_DATA' => FbaFulfillmentCustomerShipmentSalesDataReport::class,
            'GET_FBA_FULFILLMENT_CUSTOMER_SHIPMENT_PROMOTION_DATA' => FbaFulfillmentCustomerShipmentPromotionDataReport::class,
            ...
            'GET_FBA_FULFILLMENT_CUSTOMER_SHIPMENT_REPLACEMENT_DATA' => FbaFulfillmentCustomerShipmentReplacementDataReport::class,
