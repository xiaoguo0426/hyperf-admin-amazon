    ...
    public function handle(): void
    {
        ...
        AmazonApp::tok2($merchant_id, $merchant_store_id, $region, static function (AmazonSDK $amazonSDK, int $merchant_id, int $merchant_store_id, SellingPartnerSDK $sdk, AccessToken $accessToken, string $region, array $marketplace_ids) {
            ...
            foreach ($marketplace_ids as $marketplace_id) {
                ...
                while (true) {
                    try {
                        $itemSearchResults = $sdk->catalogItem()->searchCatalogItems($accessToken, $region, [$marketplace_id], $identifiers, $identifiers_type, $included_data, $locale, $seller_id, $keywords, $brand_names, $classification_ids, $page_size, $page_token, $keywords_locale);
